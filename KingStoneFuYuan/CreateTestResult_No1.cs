...
namespace KingStoneFuYuan
{
    public partial class CreateTestResult_No1 : Form
    {
        ...
        public string m_DataBaseFilePath = System.Windows.Forms.Application.StartupPath + "\\1#\\DataBase.mdb";
        ...
        private void CreateTestResult_No1_Load(object sender, EventArgs e)
        {
            ...
            dataGridView_DateList_e.ReadOnly = true;
        ...
        private void CreateTestResult_No1_Shown(object sender, EventArgs e)
        {
        ...
        private bool CreatOfficeReport()
        {
            ...
            try
            {
                ...
                //WordToPDF(filename.ToString(), newFile.ToString());
...
                Console.WriteLine(e.Message);                   
        ...
        private void textBox_EndTime_e_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            textBox_EndTime_e.Size = new Size(120, 14);
            DateTime EndTime = default(DateTime);
            if (m_isOpenDataBase)
            {
                EndTime = m_HistoryEndTime;
                textBox_EndTime_e.Text = EndTime.ToShortDateString() + " " + EndTime.ToLongTimeString();
            }
            else
            {
                EndTime = m_BenchHandle.m_EndTime;
            ...
            textBox_EndTime_e.BorderStyle = BorderStyle.Fixed3D;
            textBox_EndTime_e.BackColor = Color.Red;
            m_isTextBoxSelect = true;
        }
