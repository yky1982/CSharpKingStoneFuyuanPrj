...
namespace KingStoneFuYuan
{
    public partial class Bench_1 : Form
    {
        ...
        private void Bench_1_Shown(object sender, EventArgs e)
        {
        ...
        private void SampleDataFun()
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("CurrentStage_Bench1", ref currentStage, ref dt);
            if (code != 1)
            {
                return;
            }
            if (currentStage == 1)
            {
                code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No1_Bench1", ref setPressure, ref dt);
                if (code != 1)
                {
                    return;
                }
            ...
            if (currentStage == 2)
            {
                code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No2_Bench1", ref setPressure, ref dt);
                if (code != 1)
                {
                    return;
                }
            ...
            if (currentStage == 3)
            {
                code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No3_Bench1", ref setPressure, ref dt);
                if (code != 1)
                {
                    return;
                }
            }
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("PressureTest_Bench1", ref TestData, ref dt);
            if (code != 1)
            {
                return;
            }
